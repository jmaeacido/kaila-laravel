...
Route::get('/queue', [MarketplaceController::class, 'app'])->name('app.queue');
Route::get('/disputes', [MarketplaceController::class, 'app'])->name('app.disputes');
Route::get('/validation', [MarketplaceController::class, 'app'])->name('app.validation');
Route::get('/analytics', [MarketplaceController::class, 'app'])->name('app.analytics');
